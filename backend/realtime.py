...
One class owns the complete runtime:
- Qwen connection and Semantic VAD
- immediate speech-start interruption (R-A)
- one active assistant response
- non-preemptive sequential dashboard tools
- compact browser events
