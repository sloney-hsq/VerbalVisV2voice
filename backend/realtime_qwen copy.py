...
# Legacy local-VAD cancellation path. Keep disabled because Qwen semantic VAD
# now owns speech-onset detection and waits for the completed transcript before
# deciding whether the utterance resumes playback or supersedes the response.
LOCAL_SPEECH_CANCEL_ENABLED = False
